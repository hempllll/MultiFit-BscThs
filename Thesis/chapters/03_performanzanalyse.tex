...
Den Spielraum zu schließen beansprucht zuerst \textcite{yue1990} mit dem Nachweis
$r_m \le 13/11$.
...
der $q$-Packung höchstens $x$; von der zweiten Eigenschaft sind einzelne Bins der $q$-Packung
ausgenommen, die erste gilt ohne Ausnahme.
...
$r_m = 13/11$ für alle $m \ge 13$; für $2 \le m < 13$
trifft diese Arbeit über den genauen Wert keine Aussage, während
Bemerkung~\ref{bem:m-mindestens-zwei} zusammen mit
Bemerkung~\ref{bem:rm-mindestens-eins} den Wert $r_1 = 1$ festlegt.
Die Instanz für $m = 13$ wird in Abschnitt~\ref{sec:friesen} empirisch untersucht.
Auf der Schranke $13/11$ beruhen über~\eqref{eq:ffd-akzeptiert} die Abschätzungen zu
MULTIFIT+FFD in den Kapiteln~\ref{kap:alternative} und~\ref{chap:evaluation}; für die übrigen
Subroutinen dient sie dort nur als Vergleichslinie.

...
beiden Schranken dienen in Abschnitt~\ref{sub:hm-garantien} deshalb als Vergleichslinien.
...
Zwei von ihnen stehen je einer instanzunabhängigen Vergleichslinie gegenüber: die Spalte zu
...
Optimum je Instanz durch $C^{*}_{\max}(\Gamma, m-1)/C^{*}_{\max}(\Gamma, m)$ - eine Schranke,
die von der Instanz abhängt und deshalb keine Güte im Sinn von Definition~\ref{def:guete}
liefert.

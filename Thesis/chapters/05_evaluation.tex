...
Theorem~\ref{thm:guete} und Korollar~\ref{kor:multifit-jansen-dual} sind für die Halbierung mit
reellen Kapazitäten aus Abschnitt~\ref{sec:multifit} bewiesen, nicht für diese Variante; die
beiden Schranken dienen in Abschnitt~\ref{sub:hm-guete} deshalb als Vergleichslinien.
...
Zwei von ihnen stehen je einer Vergleichslinie gegenüber: die Spalte zu
MULTIFIT+FFD dem Wert $13/11 + 2^{-k} \approx \HmSchrankeK$ nach \textcite{cao1995}, die
Spalte zu MULTIFIT+$\mathrm{J}_\varepsilon$ dem Wert $(1+\varepsilon)(1+2^{-k})$ aus
Korollar~\ref{kor:multifit-jansen-dual}, wobei $\varepsilon = 1/(2d-1)$ hier zwischen
\HmEpsTheorieMin{} und \HmEpsTheorieMax{} liegt.
Beide Werte sind für die reellwertige Halbierung bewiesen, nicht für die hier gemessene
ganzzahlige Suche (Abschnitt~\ref{sub:hm-aufbau}); beim $\varepsilon$-dualen kommt hinzu, dass
die Fassung ohne innere Binärsuche gemessen wird, für die das Argument am Ende von
Abschnitt~\ref{sub:eps_dual} trägt und nicht Korollar~\ref{kor:multifit-jansen-dual} selbst.
...
Eine von $d$ unabhängige Konstante liefert Lemma~\ref{lem:gg-rundung} dagegen nicht, und ob es
eine gibt, ist offen.

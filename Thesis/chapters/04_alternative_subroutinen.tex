...
Da die Aufgabengrößen ganzzahlig sind, lässt eine Kapazität $C$ dieselben Packungen zu wie
$\lfloor C \rfloor$; verwendet wird deshalb die Variante der Binärsuche mit ganzzahligen
Kapazitäten (Abschnitt~\ref{sub:hm-aufbau}).

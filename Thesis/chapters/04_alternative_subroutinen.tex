...
der Term $2^{-k}$ hinzu.
Das ist eine Schranke je Instanz und keine Güte im Sinn von Definition~\ref{def:guete}, denn
der Quotient ist über alle Instanzen nicht beschränkt.
...
Eine von $d$ unabhängige Konstante liefert Lemma~\ref{lem:gg-rundung} dagegen nicht; ob es
eine gibt, bleibt offen.

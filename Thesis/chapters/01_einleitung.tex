...
\todo[inline]{Alle textuellen Aussagen im Dokument auf Zitationsbedarf prüfen (fehlt an manchen
Stellen eine Quellenangabe?) und alle vorhandenen Zitate auf Korrektheit verifizieren. Von den
Quellen der Einleitung ist \cite{graham1969} am Volltext geprüft; \cite{graham1966}
und \cite{sahni1976} sind bislang nur über die Verlagsmetadaten abgeglichen.}
...
Gefragt sind deshalb Verfahren, welche schnell eine Zuordnung liefern und deren Abstand zum
Optimum sich beweisen lässt.

\paragraph{Bekannte Ansätze.}
Die erste Garantie dieser Art stammt von \textcite{graham1966}.
Sein Listen-Scheduling durchläuft die Aufgaben in einer beliebigen Reihenfolge und legt jede auf
...
Werden die Aufgaben zuvor absteigend sortiert, so sinkt dieser Faktor auf $4/3 - 1/(3m)$, und der
Wert ist scharf \cite[Theorem~2]{graham1969}.
...
Statt die Aufgaben unmittelbar zu verteilen, rät das Verfahren eine Kapazität und überlässt einem
Bin-Packing-Algorithmus die Frage, ob die Aufgaben in $m$ Behälter dieser Kapazität passen.
...
Eine Binärsuche über die Kapazität, nach $k$ Halbierungsschritten abgebrochen, macht daraus eine
Zuordnung.
...
Approximation, bei der nicht die Zahl der Behälter, sondern deren Kapazität aufgeweicht wird.
...
Das Verhältnis von erzeugtem zu optimalem Makespan sinkt dadurch auf $72/61$ - asymptotisch
scharf und damit unter $13/11$ -, während die Laufzeitordnung $O(n \log n)$ erhalten bleibt.
...
\cite{johnson_garey1985, yue_zhang1995}, woraus jedoch nicht folgt, dass MFFD im schlechtesten
Fall tatsächlich besser abschneidet.
...
Kein gemessenes Verhältnis überschreitet dabei $13/11$ - für MULTIFIT+FFD ist das die bewiesene
Schranke, für die übrigen Kombinationen lediglich eine Vergleichslinie.
